...
category: "技术"
summary: "PL5 用 Agent 包装 P5 的朴素贝叶斯引擎，Agent 收集症状后触发概率推理，解释后验概率并可查询先验与似然比。"
faq:
  - q: "PL5 和 PL4 的核心差异？"
    a: "PL4 做模糊匹配（处理严重度），PL5 做概率推理（处理后验概率），输入上 PL5 只需二元症状。"
  - q: "query_prior_and_likelihood 是做什么的？"
    a: "PL5 独有工具，用于查询某疾病的先验概率与各症状的似然比，支撑对结论的拆解解释。"
  - q: "PL5 的结论怎么解释？"
    a: "按「先验 × 似然 → 后验」的链条逐项展示，用户能看到每条证据对结论的贡献。"
---
