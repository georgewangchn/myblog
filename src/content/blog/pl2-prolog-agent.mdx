...
category: "技术"
summary: "PL2 用 LangGraph Agent 包装 P2 的 Prolog 引擎，支持自然语言问诊、SLD 归结推理，以及疾病传播链查询。"
faq:
  - q: "PL2 和 PL1 的差异是什么？"
    a: "Agent 框架相同，换了一套工具：后端是 Prolog，因此能做 OWL 做不到的递归推理与传播链查询。"
  - q: "传播链查询有什么价值？"
    a: "可以沿递归规则查出疾病之间的传播路径，这是 Prolog 递归能力的直接体现。"
  - q: "CWA 和 OWA 对 Agent 有什么影响？"
    a: "同一病例在封闭/开放世界假设下可能得到不同结论，Agent 需要据此调整追问与判断策略。"
---
